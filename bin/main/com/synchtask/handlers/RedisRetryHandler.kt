 ...
 * **Redis Retry Handler**
 *
 * - Ensures messages are retried when Redis fails.
 * - Uses exponential backoff for smart retries.
 */
@Component
class RedisRetryHandler(
    ...
    /**
     * **Retries message publishing on Redis failure**
     *
     * @param channel Redis channel where the message is being sent.
     * @param message The actual message that failed.
     * @param attempt Current attempt number for retry.
     */
