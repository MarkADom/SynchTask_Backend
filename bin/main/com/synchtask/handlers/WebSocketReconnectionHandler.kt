...
class WebSocketReconnectionHandler(
    ...
    /**
     * **Schedules WebSocket reconnection attempts with exponential backoff**
     */
    ...
    /**
     * **Shutdown the reconnection scheduler gracefully**
     */
    fun shutdown() {
        scheduler.shutdown()
        try {
    ...
    companion object {
        ...
        private const val BASE_BACKOFF_DELAY_MS = 2000L // Base delay in milliseconds
