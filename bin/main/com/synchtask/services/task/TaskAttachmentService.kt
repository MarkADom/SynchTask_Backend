 ...
 *
 * Handles uploading, listing and deletion of file attachments related to tasks.
 * Ensures that only the task owner or admins are authorized to perform these actions.
 */
@Service
class TaskAttachmentService(
    ...
    /**
     * Uploads a file and associates it with a task if the user owns the task.
     */
    @Transactional
    ...
    /**
     * Lists all attachments for a task if the user owns the task.
     */
    ...
    /**
     * Deletes an attachment from a task if the user owns the task.
     */
    @Transactional
