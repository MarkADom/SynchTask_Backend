 ...
 * **Task Link Service**
 *
 * Manages creation, listing and removal of links associated with tasks.
 * Validates task ownership based on the authenticated user.
 */
@Service
class TaskLinkService(
    ...
    /**
     * Adds a new link to the specified task, ensuring the authenticated user owns the task.
     */
    @Transactional
    ...
    /**
     * Returns all links associated with a task.
     */
    ...
    /**
     * Removes a specific link from a task, verifying user ownership.
     */
    @Transactional
